...
public class TransactionService {
    ...
    public Transaction addTransaction(String accountId,
        ...
        applyDelta(account, type, normalized, when);
        ...
        ledgerFor(accountId).add(tx);
        upsertStoreTransaction(tx, account.getName());
        return tx;
    }
    ...
    private void upsertStoreTransaction(Transaction tx, String accountName) {
        DataStore.upsertTransaction(new DataStore.Transaction(
                tx.id,
                tx.date.toString(),
                tx.type.name(),
