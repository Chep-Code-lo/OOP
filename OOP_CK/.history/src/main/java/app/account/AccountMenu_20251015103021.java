package org.example.finance.ui;

import org.example.finance.app.FinanceManager;


import org.example.finance.core.BankAccount;
import org.example.finance.core.EWalletAccount;
...
public class AccountMenu {
    ...
    private void add(Scanner sc, FinanceManager fm) {
        ...
        String name = readLine(sc, "Tên tài khoản: ");
        ...
        if (readYesNo(sc, "Bạn có muốn nạp số dư ban đầu? (y/n): ")) {
    ...
    private void rename(Scanner sc, FinanceManager fm) {
        ...
        String id = readLine(sc, "ID tài khoản cần đổi tên: ").trim();
        ...
        String newName = readLine(sc, "Tên mới: ").trim();
    ...
    private void delete(Scanner sc, FinanceManager fm) {
        ...
        String id = readLine(sc, "ID tài khoản cần xóa: ").trim();
        fm.deleteAccount(id);
    ...
    /** Đọc yes/no, chấp nhận y/yes/n/no (không phân biệt hoa thường). */
