...
public class Actions {
     public void add(Scanner sc, FinanceManager fm) {
    ...
    public void rename(Scanner sc, FinanceManager fm) {
    ...
    public void delete(Scanner sc, FinanceManager fm) {
        if (fm.listAccounts().isEmpty()) {
            System.out.println("Chưa có tài khoản nào. Vào menu 'Thêm tài khoản' để tạo mới.");
            return;
        }
    ...
    public BigDecimal readAmount(Scanner sc, String prompt) {
