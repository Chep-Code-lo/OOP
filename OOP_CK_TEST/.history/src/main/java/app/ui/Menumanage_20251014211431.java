...
public class Menumanage {
    ...
    public Menumanage() {
        ...
        // optionally seed default accounts
        this.app.seed();
    }
        ...
        while (true) {
            ...
            try {
                switch (sc.nextLine().trim()) {
                    case "1": app.showBalances(); break;
                    case "2": app.addTxCLI(sc); break;
                    case "3": app.listTxCLI(sc); break;
                    case "4": app.editTxCLI(sc); break;
                    case "5": app.deleteTxCLI(sc); break;
